...
Do {
    ...
    Write-Output "New-NetFirewallRule -DisplayName \"$RuleName-#$iCount\" -Direction Inbound -Action Block -LocalAddress Any -RemoteAddress $TextRanges -Description $Description -Profile $ProfileType -InterfaceType $InterfaceType | Out-Null"
    ...
    Write-Output "New-NetFirewallRule -DisplayName \"$RuleName-#$iCount\" -Direction Outbound -Action Block -LocalAddress Any -RemoteAddress $TextRanges -Description $Description -Profile $ProfileType -InterfaceType $InterfaceType | Out-Null"
